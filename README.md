...
<details>
  ...
  Foi construída uma aplicação de cadastro de talkers (palestrantes) onde é possível cadastrar, visualizar, pesquisar, editar e excluir informações. Para isso foi criada:
  1. Uma API `CRUD` (**C**reate, **R**ead, **U**pdate e **D**elete) de palestrantes (talkers) e;
  2. Alguns endpoints para ler e escrever em um arquivo utilizando o módulo `fs`.
...
<details>
  <summary><strong>‼️ Para usar</strong></summary><br />
